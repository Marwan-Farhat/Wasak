...
<body>
                        ...
                        <div class="col-lg-12">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-4c">
                                    <h4 class="fs-20 m-0 text_cap">{{ __('welcome.عنا نصوص الصفحة') }}</h4>
                                </div>
                                <div>
                    ...
                    <div class="table-responsive px-3">
                        <table id="example" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                ...
                                {{--  <th>
                                    <span class="text-nowrap text_cap">الوصف</span>
                                </th>  --}}
                                <th class="text-center">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg Home-project-card" dir="rtl">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center justify-content-between">
                    <h5 class="modal-title fw-bolder fs-20 text-1 text_cap" id="viewModalLabel"> {{ __('welcome.عنا نصوص الصفحة') }}</h5>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg  Home-project-card">
            <div class="modal-content ">
                ...
                <div class="modal-body py-4">
                  <form action="{{ url('/updateText') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div id="formdata"></div>
    ...
    <div class="modal  fade" id="addmodal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg  Home-project-card">
            <div class="modal-content ">
                <div class="modal-header d-flex align-items-center justify-content-between">
                    <h5 class="modal-title fw-bolder fs-20 text-1 text_cap" id="viewModalLabel">عنا نصوص الصفحة</h5>
                    <button type="button" class="btn-close m-0" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body py-4">
                    <form action="{{ url('/addText') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-lg-6 mt-3">
                        <div class="d-flex flex-column gap-4c">
                            ...
                            <div class="d-flex flex-column gap-4c">
                                ...
                                <textarea class="" id="editor" name="ar_description"
                                rows="5"></textarea>
                                </div>
                        </div>
                        <div class="col-lg-6 mt-3">
                            <div class="d-flex flex-column gap-4c">
                                ...
                                <div class="d-flex flex-column gap-4c">
                                    ...
                                    <textarea class="" name="description"  id="editor2"
                                    rows="5"></textarea>
                                    </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="d-flex gap-2  ">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-column gap-4c">
                                            <label class="fs-12 fw-400-20px text-1">الوصف</label>
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    showdata +=
                            ...
                            $('#viewDescription').html(response.data.ar_description)
