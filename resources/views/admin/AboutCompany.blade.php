                ...
                <div class="container  p-24">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-sm-12 col-md-9 col-lg-9">
                            <h4 class="fs-20 my-1 text_cap">{{ __('welcome.عن الشركة') }} </h4>
                        </div>
                    </div>
                    <form action="{{ url('/updateAboutCompany') }}" method="post" enctype="multipart/form-data" class="row m--100">
                        @csrf
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <p>image aspect ratio : 575 x 383 px</p>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="row gap-16 g-5">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="d-flex flex-column gap-4c my-4">
                                            ...
                                            {{ __('welcome.الوصف باللغة العربية') }}
                                            </label>
                                            <textarea id="editor2" class="form-control" required name="ar_description" rows="6">{{ $data->ar_description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 ">
                            <div class="d-flex flex-column gap-4c">
                                ...
                                <input type="text"  class="form-control fw-400-24px gray-text-2 pad-8-16" value="{{ $data->whatsappNumber }}" required name="whatsappNumber"
                                    placeholder="">
                                </div>
                        </div>
