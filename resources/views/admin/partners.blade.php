...
<head>
    ...
    <title>{{ __('welcome.شركاء النجاح') }}</title>
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <!-- /#sidebar-wrapper -->
        <!-- Page Content -->
        <div id="page-content-wrapper" class="dir_rtl">
            ...
            <div class="h-500px scroll" id="page-content-wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-4c">
                                    ...
                                    <div class="d-flex">
                                        <h4 class="fs-20 m-0 text_cap">{{ __('welcome.شركاء النجاح') }}</h4>
                                        @if ($status->partner == 1)
                                            <div class="me-3" id="someContainerTwo">
                                                <a class="text-decoration-none"
                                                    href="{{ url('/updateCounterStatusHidePartner') }}">
                                        ...
                                        @else
                                            <div class="me-3" id="someContainer">
                                                <a class="text-decoration-none"
                                                    href="{{ url('/updateCounterStatusPartner') }}">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-16">
                                                <span class="fs-14 text-1 fw-500-20 text_cap text-center mt-3"  >
                                                    <img src="{{ $partner->image }}" class="audit1" alt="" style="width: 100px; height:100px">
                                                </span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group d-flex justify-content-center gap-2">
                                                ...
                                                <div class="btn-group d-flex justify-content-center gap-2">
                                                    <button type="button" class="pinButton p-2 border-blue py-2 px-2 rounded-2 d-flex justify-content-center align-items-center {{$partner->pinStatus ? 'disabled' : ''}}" data-bs-toggle="modal" data-partner-id="{{$partner->id}}">
                                                        <i class="fa-solid fa-thumbtack" style="color: {{$partner->pinStatus ? '#33d1cc' : '#ffffff'}};"></i>
                                                    </button>
                                                </div>
                                                {{--  @if($partner->status == 1)
                                                <a href="{{ url('/unPinPartner/'.$partner->id) }}"
                                                    class="p-2  py-2 px-2 rounded-2 d-flex justify-content-center align-items-center pin-button border-0"
                                                    >
                                                    <img src="assets/images/pin.svg" alt="">
                                                </a>
                                                @else
                                                <a href="{{ url('/PinPartner/'.$partner->id) }}"
                                                class="p-2  py-2 px-2 rounded-2 d-flex justify-content-center align-items-center pin-button border-0">
                                                <img src="assets/images/pin.svg" alt="">
                                                </a>
                                                @endif  --}}
                ...
                <!-- <div class="container p-24">
                    <div class="d-flex justify-content-end ">
                        <button class="btn1" onclick="addRow()" >ADD +</button>
                    </div>
                    <div class="plus">
                        <div class="row">
                                ...
                                <div class="d-flex gap-2  ">
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-column gap-4c">
                                            <label class="fs-12 fw-400-20px text-1">{{ __('welcome.عنوان') }}</label>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg  Home-project-card" dir="rtl">
            <div class="modal-content ">
                    ...
                    <div class="row justify-content-center ">
                        <div class="col-12 col-sm-12 col-md-10 col-lg-10">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="d-flex align-items-end  justify-content-center " id="showImage">
                                    </div>
                ...
                <div class="modal-footer gap-12">
                    <button type="button" class="btncust border-0 bg-link text-white text_cap"
                        data-bs-dismiss="modal">{{ __('welcome.تم') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal  fade" id="addmodal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg  Home-project-card">
            <div class="modal-content ">
                <div class="modal-header d-flex align-items-center justify-content-between">
                    <h5 class="modal-title fw-bolder fs-20 text-1 text_cap" id="viewModalLabel"> </h5>
                    <button type="button" class="btn-close m-0" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body py-4">
                    <form action="{{ url('storePartners') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row p-2">
                            <div class="col-lg-12">
                                ...
                                <p class="text-end">image aspect ratio : 159 x 32 px</p>
                            </div>
    ...
    <div class="modal  fade" id="editRequest" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg  Home-project-card">
            <div class="modal-content ">
                ...
                <div class="modal-body py-4">
                    <form action="{{ url('/updatePartner') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-lg-6 mt-3">
                            <div class="d-flex flex-column gap-4c">
                                <label class="fs-12 fw-400-20px text-1 text-end">{{ __('welcome.عنوان') }}</label>
                                <input type="text" class="form-control fw-400-24px gray-text-2 pad-8-16"
                                    name="ar_title" id="editar_Title" placeholder="">
                            </div>
                        </div>
                        <div class="col-lg-6 mt-3">
                            <div class="d-flex flex-column gap-4c">
                ...
                <div class="modal-body">
                    <form class="d-flex flex-column gap-24">
                        <div class="row gap-16">
                            <div class="col-lg-12">
                                <div class="d-flex flex-column gap-4c">
                                    <p class="text-1 text-end fw-400-24px fs-16">{{ __('welcome.هل تريد الحذف ؟') }}
                                    </p>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $('.pinButton').on('click', function() {
            ...
            button.find('i').css('color', newStatus == 1 ? '#33d1cc' : '#ffffff');
                        toastr.options = {
                            "closeButton": true,
                            "progressBar": true
                        }
    ...
    <script>
        $(document).ready(function (){
            $(document).on('click','.btnView', function(){
                ...
                $.ajax({
                    type:"GET",
                    url:"api/editPartner/"+sutd_id,
                    success: function(response){
                    var imageOne = '';
                    var image = '';
                    var url = response.partner.image

                    imageOne +=
                            `
                            <p class="fs-1 text-muted text-center pt-3" id="ar_description_view"> ${response.partner.ar_title}</p>
                                    <p class="fs-1 text-muted text-center pt-3" id="description_view"> ${response.partner.title}</p>
                            `
                    image +=
                    `
                        <img src="${url}" class="img_50" alt style="width:350px; height:300px">
                    `
                    $('#showImage').html(image)
                    $('#showContent').html(imageOne)
        ...
        $(document).ready(function (){
            $(document).on('click','.btnEdit', function(){
                ...
                $.ajax({
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="d-flex mt-1 flex-column justify-content-center align-items-center">
                                <div class="hw-100-m" onclick="HandleBrowseClick();">
                                    ...
                                    <img src="${url}" class="img-fluid w-100 h-100 rounded-2 m-0" id="output3">
                                </div>
                            </div>
                        </div>
                        <p class="text-end">image aspect ratio : 159 x 32 px</p>
                    ...
                    $('#imageDev').html(image)
                        $('#editID').val(sutd_id)
                        $('#editTitle').val(response.partner.title)
                        $('#editar_Title').val(response.partner.ar_title)
